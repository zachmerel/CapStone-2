...
import com.trilogyed.retailedgeservice.feign.PurchaseClient;
...
public class InvoiceControllerTest {
    ...
    @MockBean
    private PurchaseClient invoiceRepo;
    ...
    public void shouldGetAllInvoice() throws Exception {
        ...
        given(invoiceRepo.getAllInvoices())
    ...
    public void shouldGetInvoiceById() throws Exception {
        ...
        given(invoiceRepo.getInvoiceById(1))
                .willReturn(optionalInvoice.get());
    ...
    public void shouldCreateUpdateAndDeleteInvoice() throws Exception {
        ...
        given(invoiceRepo.createInvoice(invoice)).willReturn(invoiceAdded);
        Optional<Invoice> optionalInvoiceAdded = Optional.of(invoice);
        given(invoiceRepo.getInvoiceById(1)).willReturn(optionalInvoiceAdded.get());
